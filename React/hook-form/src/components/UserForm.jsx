...
const handleFirstName = (e)=>{setFirstName(e.target.value);
    ...
    const handleLastName = (e)=>{setFirstName(e.target.value);
        if(e.target.value.length < 1) {
    ...
    const handleLEmail = (e)=>{setEmail(e.target.value);
        if(e.target.value.length < 1) {
    ...
    const handlePasswordConfirme = (e)=>{setConfirmPassword(e.target.value);
